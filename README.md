# Fashion Week Contract Builder

A localhost-only Markdown editor that generates a Flying Solo Fashion Week contract title and resolved Markdown body from protected legal wording, placeholders, and validated commercial fields.
